...
**Exemplo:** Tipo de retorno da requisição (XML, CSV, Porcento) // Calculador de Descontos

O padrão pode ser usado quando houver muitas condições para quando uma não for verdadeira, automaticamente tente a próxima. Com o Chain of Responsability fica mais elegante e enxuto o código.
